		...
		public function GetAllThreeEnvoieTanaOrange($montant)
		{
			switch ($montant) {
				case 200<$montant AND $montant<=1000:
					...
					$bonus = 9;
				break;
				case 1000<$montant AND $montant<=5140:
					$frais = 100;
					$bonus =60;
				break;
				// -------- NOT DONE
					case 5140:
						...
						$bonus = 60;
					break;
					case 5140<$montant AND $montant<=10275:
						$frais = 200;
						$bonus = 128;
					break;
				// -------- NOT DONE
				case 10275:
					...
					$bonus = 128;
				break;
				case 10275<$montant AND $montant<=25000:
					$frais = 400;
					$bonus = 188;
				break;
				// -------- NOT DONE
					case 25650:
						...
						$bonus = 297;
					break;
					case 25000<$montant AND $montant<=51300:
						$frais = 400;
						$bonus = 297;
					break;
				// -------- NOT DONE
				case 51300:
					...
					$bonus = 297;
				break;
				case 51300<$montant AND $montant<=102000:
					$frais = 800;
					$bonus = 339;
				break;
				// case 102000:
			...
			switch ($montant) {
				...
				// -------- NOT DONE
					case 5140:
						...
						$bonus = 60;
					break;
					case 5000<$montant AND $montant<=10275:
						$frais = 300;
						$frais_retire = 100;
						$bonus = 128;
					break;
