...
class Operateur
{
	...
	// TELMA TRANSACTION -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		{
			switch ($montant) {
				case 300<$montant_retrait AND $montant_retrait<=5000:
					$bonus = 50;
				break;
				case 5000<$montant_retrait AND $montant_retrait<=10000:
					$bonus = 83.33;
				break;
				case 10000<$montant_retrait AND $montant_retrait<=20000:
					$bonus = 250;
				break;
				case 20000<$montant_retrait AND $montant_retrait<=30000:
					$bonus = 279.17;
				break;
				case 30000<$montant_retrait AND $montant_retrait<=40000:
					$bonus = 458.33;
				break;
				case 40000<$montant_retrait AND $montant_retrait<=50000:
					$bonus = 583.33;
				break;
				case 50000<$montant_retrait AND $montant_retrait<=60000:
					$bonus = 583.33;
				break;
				case 60000<$montant_retrait AND $montant_retrait<=100000:
					$bonus = 916;
				break;
				case 100000<$montant_retrait AND $montant_retrait<=250000:
					$bonus = 1583.33;
				break;
				case 250000<$montant_retrait AND $montant_retrait<=500000:
					$bonus = 2083.33;
				break;
				case 500000<$montant_retrait AND $montant_retrait<=1000000:
					$bonus = 2500;
				break;
				default:
					$bonus = "Invalide";
		...
		{
			switch ($montant) {
				case 200<$montant_retrait AND $montant_retrait<=1000:
					$bonus = 49;
				break;
				case 1000<$montant_retrait AND $montant_retrait<=5000:
					$bonus = 58;
				break;
				case 5000<$montant_retrait AND $montant_retrait<=10000:
					$bonus = 100;
				break;
				case 10000<$montant_retrait AND $montant_retrait<=25000:
					$bonus = 225;
				break;
				case 25000<$montant_retrait AND $montant_retrait<=50000:
					$bonus = 500;
				break;
				case 50000<$montant_retrait AND $montant_retrait<=100000:
					$bonus = 900;
				break;
				case 100000<$montant_retrait AND $montant_retrait<=250000:
					$bonus = 1567;
