<?php 
	include '../../controller/operateur/airtel.php';
?>
		...
		<div style="background: #f4f6f9">
			<div class="content-header">
			  <div class="container-fluid">
			    <div class="row">
			      <div class="col-sm-6">
			        <h1 class="m-0"><img src="../../content/image/airtel.png" width="30" height="30" class="img-responsive mb-2 img-circle"> Airtel</h1>
			      </div>
			      <div class="col-sm-6">
				...
				<div class="container-fluid">
					<div class="row">
						  <div class="col-lg-2">
					              ...
					              <div class="inner">
					              	<div class="row">
					              		...
					              		<div class="col-sm-6 text-right">
					                		<p class="mb-0"><?= number_format($soldeAirtelAffiche); ?>Ar</p>
					              		</div>
					              	</div>
					              	<div class="row">
					              		<div class="col-sm-6 text-left">
					            ...
					            <div class="card">
					            	<form method="POST">
					            		<button class="btn btn-block btn-outline-danger btn-sm" type="submit" name="finishDay">Finir la journée</button>
					            	</form>
					            </div>
					           	<?php } ?>
						  </div>
					          	...
					          	<div class="card-body">
					          		<form method="POST">
						          		<div class="w-100">
						            		...
						            		<input type="number" name="addSoldeAirtel" class="form-control" placeholder="Ariary" min="0">
						            	</div>
						            	<div class="mt-2 w-100">
						            		<p class="mb-2">Ajout Espece</p>
						            		<input type="number" name="addEspece" class="form-control" placeholder="Ariary" min="0">
						            	</div>
						            	<div class="mt-2 w-100">
					          	...
					          	<div class="card-body">
					          		<form method="POST">
						          		<div class="w-100">
						            		...
						            		<input type="number" name="subSoldeAirtel" id="subSoldeAirtel" class="form-control" placeholder="Ariary" min="0">
						            	</div>
						            	<div class="mt-2 w-100">
						            		<p class="mb-2">Retire Espece</p>
						            		<input type="number" name="subEspece" id="subEspece" class="form-control" placeholder="Ariary" min="0">
						            	</div>
						            	<div class="mt-2 w-100">
						            		<p class="mb-2">Raison</p>
					          	...
					          	<div class="card-body">
					          		<form method="POST">
						          		<div class="w-100">
						            		...
						            		<input type="text" name="sendTNumero" class="form-control" placeholder="Numero" value="0332487719" required>
						            	</div>
						            	<div class="w-100">
					          ...
					          <div class="card h-100">
					          	...
					          	<div class="card-body">
					          		<form method="POST">
						          		<div class="w-100">
						            		<p class="mb-2">Numero</p>
						            		<input type="text" name="retraitTNumero" class="form-control" placeholder="Numero" value="0332487719" required>
						            	</div>
						            	<div class="w-100">
						            		<p class="mb-2">Montant</p>
